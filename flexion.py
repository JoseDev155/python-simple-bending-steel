def calculoFlexion(b: float, h: float, recub: float, fc: float, fy: float, Mu: float):
    # INGRESO DE DATOS
    #b = 0.2
    #h = 0.4
    #recub = 0.05
    ...
    roMax = gamma*beta1*fc/fy*eu/(eu+0.005) # Cuantía máxima de acero
    ...
    AsMin = max(AsMin1, AsMin2) # Acero Mínimo en m^2
